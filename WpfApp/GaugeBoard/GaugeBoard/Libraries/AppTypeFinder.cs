...
{
    public class AppTypeFinder : Proxy, ITypeFinder
    {
        #region Fields
        ...
        /// <remarks>If you change this so that Nois assemblies arn't investigated (e.g. by not including something like "^Nois|..." you may break core functionality.</remarks>
        ...
        /// Proxy name
        /// </summary>
        public const string Name = "AppTypeFinder";
        #endregion

        #region Ctrs
        public AppTypeFinder(): base(Name)
        {
        }
        #endregion
