define(function (require) {
  ...
  var angular = require('angular'),
    ...
    opcViewerTpl = require('text!./templates/detail/opc-viewer.html'),
    opcGroupTpl = require('text!./templates/detail/opc-group.html');
  ...
  module.run([
    ...
    function ($templateCache) {
      ...
      $templateCache.put('home/templates/detail/opc-viewer.html', opcViewerTpl);
      $templateCache.put('home/templates/detail/opc-group.html', opcGroupTpl);
    }]);
